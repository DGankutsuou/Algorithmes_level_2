...
float calculat_average_of_array(int array[100], int array_length)
{
    float average;
    average = (float)calculat_sum_of_array(array, array_length) / array_length;
...
int main()
{
    ...
    cout << "The average is: " << calculat_average_of_array(array, array_length);
