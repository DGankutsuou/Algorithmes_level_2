...
int main()
{
    ...
    number_position = find_number_position_in_array(array, array_length, number);
    ...
    if(number_position == -1)
    {
        ...
        cout << "The number position is: " << number_position << endl;
        cout << "And its order is: " << number_position + 1 << endl;
    }
